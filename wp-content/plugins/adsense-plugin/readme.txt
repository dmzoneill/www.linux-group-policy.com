...
3. Plugin settings are located in "BWS Plugin", "AdSense".
...
At the page of plugin settings open menu item 'Position & Numbers of Ads' and on 'Position' list choose appropriate for you position.
...
= V1.3 - 31.01.2012 =
* NEW : Dutch language file is added.
